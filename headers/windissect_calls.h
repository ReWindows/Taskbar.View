...
static constexpr wchar_t module_name[17] = {0x0054, 0x0061, 0x0073, 0x006B, 0x0062, 0x0061, 0x0072, 0x002E, 0x0056, 0x0069, 0x0065, 0x0077, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 1785884217U || rva >= image_size) return nullptr;
return base + rva;
}
