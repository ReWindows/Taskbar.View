// Flat C exports observed in Taskbar.View.dll. Unknown ABIs are intentionally not declared.
// Validated dialects: ISO C17/C23/C26 draft and Windissect C20 (C ABI under C++20).
#pragma once
#ifndef TASKBAR_VIEW_C_H
#define TASKBAR_VIEW_C_H
