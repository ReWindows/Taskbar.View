//! Windissect-generated Rust FFI bindings for Taskbar.View.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "1A545A37EB1E419AB835E94A8F18F077";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 1785884217;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 17] = [84, 97, 115, 107, 98, 97, 114, 46, 86, 105, 101, 119, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 1785884217 { return 0; }
